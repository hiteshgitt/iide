...
<footer class="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20">
      <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div class="mb-10 w-full">
              <a href="javascript:void(0)" class="mb-6 inline-block max-w-[160px]">
                <img src="http://localhost/iide/wp-content/uploads/2023/06/IIDE-Logo.svg" alt="logo" class="max-w-full">
              </a>
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="mb-9 text-lg font-semibold text-dark">Career</h4>
              <ul>
                <li>
                  <a href="javascript:void(0)" class="mb-2 inline-block text-base leading-loose text-body-color hover:text-primary">
				  Hire from us
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div class="mb-10 w-full">
              ...
              <p class="text-base text-body-color">© 2023 IIDE</p>
            </div>
          </div>
        </div>
      </div>
	...
	<div>
		<?php
		$iide_blog_info = get_bloginfo( 'name' );
		if ( ! empty( $iide_blog_info ) ) :
			?>
		...
		printf(
			...
			esc_url( __( 'https://wordpress.org/', 'iide' ) ),
			'WordPress'
		);
		?>
	</div>
